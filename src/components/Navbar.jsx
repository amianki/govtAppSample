...
const navigation = [
  ...
  { name: 'GALLERY', href: '/GalleryPage', current: false },
  { name: 'COMMITTEE', href: '#', current: false },
...
export default function Navbar() {
  return (
    <Disclosure as="nav" className="bg-gradient-to-r from-gray-100 via-[#bce1ff] to-gray-100">
      {({ open }) => (
        <>
            ...
            <div className="relative flex h-16 items-center justify-between">
              ...
              <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                ...
                <div className="hidden sm:ml-6 sm:block">
                  <div className="flex space-x-28 items-center justify-center font-semibold ">
                    {navigation.map((item) => (
                      <a
                        key={item.name}
                        href={item.href}
          ...
          WEST BENGAL PANCHAYAT AND RURAL DEVELOPMENT EMPLOYEES ASSOCIATION
          </span> */}
